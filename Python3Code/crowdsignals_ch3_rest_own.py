...
DATASET_FNAME = 'chapter3_result_outliers_own.csv'
RESULT_FNAME = 'chapter3_result_final_own.csv'
ORIG_DATASET_FNAME = 'chapter2_result_own.csv'
...
def main():
    ...
    if FLAGS.mode == 'imputation':
        ...
        periodic_measurements = ['acc_phone_x', 'acc_phone_y', 'acc_phone_z',
