...
DATASET_FNAME = 'chapter2_result_own.csv'
RESULT_FNAME = 'chapter3_result_outliers_own.csv'
...
train_X, test_X, train_y, test_y = prepare.split_single_dataset_regression_by_time(dataset, 'hr_watch_rate', '1970-01-01 00:00:00',
...
basic_features = ['acc_phone_x','acc_phone_y','acc_phone_z',
                  ...
                  'labelSitting','labelWalking','labelStanding','labelBiking',
...
print('possible features has:', len(possible_feature_sets))
...
DataViz.plot_performances_regression(['RNN'], feature_names, scores_over_all_algs)
