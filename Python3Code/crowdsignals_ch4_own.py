...
DATASET_FNAME = 'chapter3_result_final_own.csv'
...
def main():
    ...
    if FLAGS.mode == 'aggregation':
        ...
        for ws in window_sizes:
            ...
            dataset = NumAbs.abstract_numerical(dataset, ['acc_phone_x'], ws, 'max')
            dataset = NumAbs.abstract_numerical(dataset, ['acc_phone_x'], ws, 'median')

        DataViz.plot_dataset(dataset, ['acc_phone_x', 'acc_phone_x_temp_max', 'acc_phone_x_temp_median', 'label'], ['exact', 'like', 'like', 'like'], ['line', 'line', 'line', 'points'])
    ...
    if FLAGS.mode == 'frequency':
        ...
        dataset = FreqAbs.abstract_frequency(dataset, ['pca_1'], ws, fs)
        # Spectral analysis.
        # DataViz.plot_dataset(dataset, ['acc_phone_x_skewness', 'acc_phone_x_energy', 'label'], ['like', 'like', 'like'], ['line', 'line', 'points'])
        # DataViz.plot_dataset(dataset, ['pca_1_max_freq', 'pca_1_freq_weighted', 'pca_1_pse', 'label'], ['like', 'like', 'like', 'like'], ['line', 'line', 'line', 'points'])
